...
public class Mythes_Cheval_Troie extends Card {
    /**
     ...
     * @param c
     */
    public Mythes_Cheval_Troie(String UID, Context c) {
        super(UID, c);
    }
    ...
    public int getCardPicture() {
        return R.drawable.t_c_cheval_troie;
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Cheval_de_Troie";
    }
