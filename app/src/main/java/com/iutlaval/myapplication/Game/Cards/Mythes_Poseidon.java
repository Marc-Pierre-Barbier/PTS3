...
public class Mythes_Poseidon extends Card{
    /**
     ...
     * @param c
     */
    public Mythes_Poseidon(String UID, Context c) {
        super(UID, c);
    }
    ...
    public int getCardPicture() {
        return R.drawable.t_c_poseidon;
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Pos%C3%A9idon#:~:text=Pos%C3%A9idon%20est%20le%20fils%20de,%C3%A0%20une%20ruse%20de%20Zeus.";
    }
