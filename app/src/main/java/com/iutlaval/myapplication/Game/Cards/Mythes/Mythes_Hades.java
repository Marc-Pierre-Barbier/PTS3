...
public class Mythes_Hades extends Card {
    /**
     ...
     * @param c
     */
    public Mythes_Hades(String UID, Context c) {
        super(UID, c);
    }
    ...
    public String getDescription() {
        return "detruit 2 créatures adverses aleatoirement";
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Had%C3%A8s";
    }
