...
public class Moyen_Age_Chretien_De_Troyes extends Card {
    /**
     ...
     * @param c
     */
    public Moyen_Age_Chretien_De_Troyes(String UID, Context c) {
        super(UID, c);
    }
    ...
    public int getCardPicture() {
        return R.drawable.t_c_chretien_de_troyes;
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Chr%C3%A9tien_de_Troyes";
    }
