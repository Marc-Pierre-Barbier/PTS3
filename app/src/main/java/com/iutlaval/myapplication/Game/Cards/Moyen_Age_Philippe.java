...
public class Moyen_Age_Philippe extends Card{
     ...
     * @param c
     */
    public Moyen_Age_Philippe(String UID, Context c) {
        super(UID, c);
    }
    ...
    public int getCardPicture() {
        return R.drawable.t_c_philippe_ii;
    }
    ...
    public String getName() {
        return "Philippe II dit Auguste";
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Philippe_II_Auguste";
    }
