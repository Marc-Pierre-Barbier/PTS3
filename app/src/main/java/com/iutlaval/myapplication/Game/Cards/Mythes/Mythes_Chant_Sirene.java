...
public class Mythes_Chant_Sirene extends Card {
     ...
     * @param c
     */
    public Mythes_Chant_Sirene(String UID, Context c) {
        super(UID, c);
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Sir%C3%A8ne_(mythologie_grecque)";
    }
