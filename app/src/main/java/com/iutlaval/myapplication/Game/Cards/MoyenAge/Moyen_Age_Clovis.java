...
public class Moyen_Age_Clovis extends Card {
     ...
     * @param c
     */
    public Moyen_Age_Clovis(String UID, Context c) {
        super(UID, c);
    }
    ...
    public String getName() {
        return "Clovis, premier roi des francs";
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Clovis_Ier";
    }
