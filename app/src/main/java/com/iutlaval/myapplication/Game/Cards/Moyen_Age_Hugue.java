...
public class Moyen_Age_Hugue extends Card{
    /**
     ...
     * @param c
     */
    public Moyen_Age_Hugue(String UID, Context c) {
        super(UID, c);
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Hugues_Capet";
    }
