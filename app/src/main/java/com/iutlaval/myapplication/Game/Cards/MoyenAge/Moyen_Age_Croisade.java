...
public class Moyen_Age_Croisade extends Card {
     ...
     * @param c
     */
    public Moyen_Age_Croisade(String UID, Context c) {
        super(UID, c);
    }
    ...
    public int getCardPicture() {
        return R.drawable.t_c_croisade;
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Croisades";
    }
