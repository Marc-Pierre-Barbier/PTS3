...
public class Moyen_Age_Jean_Vienne extends Card {
    /**
     ...
     * @param c
     */
    public Moyen_Age_Jean_Vienne(String UID, Context c) {
        super(UID, c);
    }
    ...
    public int getCardPicture() {
        return R.drawable.t_c_jean_vienne;
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Jean_de_Vienne";
    }
