...
public class Moyen_Age_PhilippeIV extends Card {
    /**
     ...
     * @param c
     */
    public Moyen_Age_PhilippeIV(String UID, Context c) {
        super(UID, c);
    }
    ...
    public int getCardPicture() {
        return R.drawable.t_c_philippe_iv;
    }
    ...
    public String getName() {
        return "Philippe IV le Roi de fer";
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Philippe_IV_le_Bel";
    }
