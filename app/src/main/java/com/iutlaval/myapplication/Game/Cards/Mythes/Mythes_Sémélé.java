...
public class Mythes_Sémélé extends Card {
    /**
     ...
     * @param c
     */
    public Mythes_Sémélé(String UID, Context c) {
        super(UID, c);
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/S%C3%A9m%C3%A9l%C3%A9";
    }
