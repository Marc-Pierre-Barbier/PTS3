...
public class Renaissance_Mehmet extends Card{
    /**
     ...
     * @param c
     */
    public Renaissance_Mehmet(String UID, Context c) {
        super(UID, c);
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Mehmed_II";
    }
