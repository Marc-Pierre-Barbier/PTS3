...
public class Mythes_Zeus extends Card{
    /**
     ...
     * @param c
     */
    public Mythes_Zeus(String UID, Context c) {
        super(UID, c);
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Zeus#:~:text=Zeus%20";
    }
