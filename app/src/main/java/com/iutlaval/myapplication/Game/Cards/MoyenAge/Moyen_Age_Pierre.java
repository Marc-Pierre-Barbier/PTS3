...
public class Moyen_Age_Pierre extends Card {
    /**
     ...
     * @param c
     */
    public Moyen_Age_Pierre(String UID, Context c) {
        super(UID, c);
    }
    ...
    public int getCardPicture() {
        return R.drawable.t_c_pierre_ermite;
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Pierre_Flote";
    }
