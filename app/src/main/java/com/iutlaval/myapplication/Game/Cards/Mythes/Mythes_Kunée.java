...
public class Mythes_Kunée extends Card {
    /**
     ...
     * @param c
     */
    public Mythes_Kunée(String UID, Context c) {
        super(UID, c);
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Kun%C3%A9e";
    }
