...
public class Moyen_Age_Roland extends Card {
    /**
     ...
     * @param c
     */
    public Moyen_Age_Roland(String UID, Context c) {
        super(UID, c);
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Roland";
    }
