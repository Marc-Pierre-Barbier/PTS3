...
public class Moyen_Age_Prise_Sainte_Terre extends Card {
     ...
     * @param c
     */
    public Moyen_Age_Prise_Sainte_Terre(String UID, Context c) {
        super(UID, c);
    }
    ...
    public int getCardPicture() {
        return R.drawable.t_c_terre_sainte;
    }
    ...
    public String getName() {
        return "prise de la terre sainte";
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Terre_sainte";
    }
