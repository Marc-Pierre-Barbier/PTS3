...
public class Moyen_Age_Christine extends Card {
    /**
     ...
     * @param c
     */
    public Moyen_Age_Christine(String UID, Context c) {
        super(UID, c);
    }
    ...
    public int getCardPicture() {
        return R.drawable.t_c_christine;
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Christine_de_Pizan";
    }
