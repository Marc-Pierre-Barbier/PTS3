...
public class Mythes_Zeus_VS_Typhon extends Card {
     ...
     * @param c
     */
    public Mythes_Zeus_VS_Typhon(String UID, Context c) {
        super(UID, c);
    }
    ...
    public int getCardPicture() {
        return R.drawable.t_c_zeus_vs_typhon;
    }
    ...
    public String getWikipediaLink() {
        return "https://fr.wikipedia.org/wiki/Zeus#Le_combat_contre_Typhon";
    }
